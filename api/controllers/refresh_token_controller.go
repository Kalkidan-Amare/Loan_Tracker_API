...
type RefreshTokenController struct {
    ...
    jwtsrv middleware.JWTService
}

func NewRefreshTokenController(uu domain.UserUsecaseInterface, rt domain.RefreshTokenUsecaseInterface, js middleware.JWTService) *RefreshTokenController {
